...
public static class ScInventoryWear {
    ...
    public static string Text(int value)=>Terrain.ExtractContents(value)==BlocksManager.GetBlockIndex<ScGunBlock>(true)
    ...
    public static void Update(InventorySlotWidget slot) {
        ...
        label.Text=text;label.IsVisible=true;label.Color=ScGunDurability.IsLow(data)||ScGunDurability.IsBroken(data)?new Color(255,115,90):Color.White;
    }
}
