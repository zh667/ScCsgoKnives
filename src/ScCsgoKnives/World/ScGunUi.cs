...
public static class ScGunUi {
    ...
    // ActualSize is reported in the screen's pixel coordinate space. 1600 incorrectly classified the
    // common 1536px desktop window as a phone, stacking the weapon list above the attributes and leaving
    // most of the right side unused. Keep the compact layout for genuinely narrow/mobile surfaces.
    public const float NarrowWidth = 1050f;
