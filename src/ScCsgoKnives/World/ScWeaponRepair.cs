...
/// <summary>Workbench repair (plan C4/C7). A full repair costs half of the gun's assembly blanks and
...
public static class ScWeaponRepair {
    ...
    /// <summary>No fixed-price exceptions under the 2026-09-12 economy, including the Zeus.</summary>
    public static readonly Dictionary<string, (int Blank, int Mechanism)> FixedFullCost = new(StringComparer.Ordinal) {
    };
    /// <summary>Full-repair cost by material kind (0 blank, 1 mechanism): half of the assembly recipe, rounded up,
