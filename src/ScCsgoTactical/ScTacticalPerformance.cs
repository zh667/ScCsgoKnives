...
public static class ScTacticalPerformance {
    public const string Revision="crowd-diag-20260926";
    public enum Stage { Placement, EntityCreate, Configure, AddEntity, ModelLoad, ModelSet,
        AnimationCache, ActionsInit, EnemyAI, CompanionAI, Animate, Bones, Extras, WeaponResolve, WeaponBuild, WeaponDraw, Director, Count }
