...
p=root/'.tmp/minimal-130-20260926/native-resources'
...
for group,names in groups.items():
    ...
    for k,name in enumerate(names):
        frames=[f for f in report['frames'] if f['asset']==name and f['alias'].startswith(group) and f['phase']==(0 if group=='idle' else .5)]
