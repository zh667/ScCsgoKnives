...
《生存战争 2》SCAPI 1.9.2.1 的 CS2 武器模组，与 `ScCsgoBox` 联动。当前开发版：0.26.4（生存内容第二轮完善，包内程序检查通过，实机验收待完成）。
...
安装包：`output/ScCsgoKnives-0.26.4.scmod`。资源来源见 `ASSET_SOURCES.md`，第三方署名见 `THIRD_PARTY_NOTICES.md`。
